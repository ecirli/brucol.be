...
<head>
    ...
    <title>Certificate Keynote WS - <?php echo gc('conf_name_short')?></title>
...
<img src="<?php echo gc('euser_logo')?>" style="width: 27%; margin-bottom: 00px; margin-top: 00px; float: right;">
	...
	<div class="de1">
		...
		<b>Keynote Certificate</b>
		<small> to the author</small>
		<h2><?php echo strtotitle($data['name_surname']) ?></h2>
		<div class="title">
			<br>
				<small>for the scientific contribution titled:</small>
				<b><?php echo strtotitle(unserialize($data['surveys']['keynote'])['keytitle']) ?></b>
   <span>Thank you for your presentation in the plenary session at this international academic platform, enhancing skills in the field, sharing your time, ideas and knowledge.</span>
		</div>
	</div>
	...
	<div class="stamp">
	<img src="https://api.qrserver.com/v1/create-qr-code/?size=80x80&data=<?php echo URL ?>get-your-certificate-keynote.php?code=<?php echo $code ?>">
	</div>
	<div class="ven">
...
/*
    ...
    $name = "http://157.180.45.169:83/api/render?url=".URL."certificate_keynote_ws__forpdf.php?code=".$code.'&pdf.landscape=true&pdf.format=A4';
