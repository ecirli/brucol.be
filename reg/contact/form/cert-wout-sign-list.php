...
<img src="<?php echo gc('icss_logo')?>" style="width: 40%; margin-bottom: 20px;float: left;">
	...
	<div class="rightlogo">
<img src="<?php echo gc('euser_logo')?>" style="width: 8%; margin-bottom: 00px; margin-top: 00px; float: right;">
	</div>
	...
	<div class="de1">
		...
		<div class="title">
				<small>for the contribution as:</small>
...
/*
    ...
    $name = "http://157.180.45.169:83/api/render?url=".URL."certificate_woutsign__forpdf.php?code=".$code.$coa.'&pdf.landscape=true&pdf.format=A4';
