<?php 
      ...
      $firstcode = vget('firstcode');
       ...
       $code = _decrypt($_GET['code']);
					...
					$data1['review_portal']['papers_reviewed4'][$code] = 'yes';
      ...
      $data = unserialize($data);
			$uid = uniqid();
      $data['arws'] = 'yes';
      $data['review_portal']['mypaperreviewed4'] = 'yes';
...
$subject = "Your Review Report";
       $htmlContent = '
            <html>
						<body>
                <h2> '.gc('conf_name_shortest').' Paper Review Report</h2>
                ...
                <br>
                2. Update your proposal (full paper or abstract) according to the review report.
                <br>
                3. Upload your updated proposal using the tool on the right side of the report page.
                <br>
                <br>                
								';
								
							  $htmlContent .= " <h4> <a href='".URL."upload-after-review-4.php?code=".$code."'> Review Report and Upload Tool</a></h4><br><br>";
                ...
                - You are advised but not fully obliged to reflect all the remarks on your proposal.<br>
                 <br>
                - Recently, we are testing the review process for "abstract only" proposals.<br>
                - In case you received a report based on your abstract, kindly update it as per suggestions.
                <br>
								<br>
                - Please send your updated propsal latest within 2 days after receiving.<br>
                 <br>
                 <br>
                 It is important for us to have your finally revised abstract to include in publishing procedure.
                 <br>
...
<br>
The review report 4 has been submitted to <?php echo gc('conf_name_shortest')?> successfully.<br>
<br>
