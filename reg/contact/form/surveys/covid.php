...
<br>
  We would like to ask you to provide a short feedback regarding your participation replanning preference to <?php echo gc('conf_name_shortest')?>.
<br>
<br>
...
<script>
  ...
  keynote_cond();
  $('._radio_covidprf').on('change', function() {
      keynote_cond();
    }
   );
function keynote_cond() {
  if ($('._radio_covidprf:checked').val() == 2) {
  $('#survey_item_2').show();
}
