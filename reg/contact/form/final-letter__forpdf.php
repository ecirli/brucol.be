...
ul.b {
  ...
  font-size: 11px;
    ...
    <div id="page">
       ...
       <a style="color: #0e6dcd; font-size: 25px;  text-align: left;  left: 250px; float: center;  position: absolute;">                                                                                                       
         <?php echo gc('conf_name_long1')?></a><a style="color: #0e6dcd; font-size: 18px;  text-align: left;  left: 280px; float: center;  position: absolute; vertical-align: super;"><?php echo gc('conf_name_long2')?></a><a style="color: #0e6dcd; font-size: 25px;  text-align: left;  left: 306px; float: center;  position: absolute;">  <?php echo gc('conf_name_long3') ?></a> 
        <br>
      <br>
      <br>
     ...
     <?php echo gc('conf_name_shortest') ?>
      ...
      <strong>Tel, WhatsApp:</strong> <?php echo gc('ltr_conf_tel')?><br>
        ...
        <p style="margin: 20px 0px;font-size: 18px;">
          ...
          <?php echo $data['fee'] == 1 ? ' We are glad to inform you that your contribution titled <b>'.strtotitle($data['paper_title']).' </b> has been reviewed, found eligible and <b>accepted</b> to be presented orally as real-time virtual form at the conference which will take place in <b> '.gc('ltr_conf_venue_short').'</b> on '.gc('ltr_conf_date').'.': ''; ?>

         <?php echo $data['fee'] == 2 ? ' We are glad to inform you that your contribution titled <b>'.strtotitle($data['paper_title']).' </b> has been reviewed, found eligible and <b>accepted</b> to be presented as real-time virtual form at the conference which will take place in <b> '.gc('ltr_conf_venue_short').'</b> on '.gc('ltr_conf_date').'.': ''; ?>

         <?php echo $data['fee'] == 3 ? ' We are glad to inform you that your contribution titled <b>'.strtotitle($data['paper_title']).' </b> has been reviewed, found eligible and <b>accepted</b> to be presented as real-time virtual form at the conference which will take place in <b> '.gc('ltr_conf_venue_short').'</b> on '.gc('ltr_conf_date').'.': ''; ?>
...
<br>
<br>
<span style="float: right; text-align: right; font-size: 10px; width: 100%; margin-bottom: 20px">
  
  <?php           // get final approve time by using regex from mail_log
              $pattern = '/approve\s*final.*?(\d{10,})\s*$/';
              $approve_ts = null;
  ...
  ?>
   ...
   <div style="margin: 20px 0px; position: relative;">
      <p>Looking forward to meeting you at the conference.<br>
