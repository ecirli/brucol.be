...
// error_reporting(E_ALL);
  ...
  date_default_timezone_set('Europe/Vienna');
    ...
    // CONFIG
    define('URL', 'https://brucol.be/reg/contact/form/');
    define('ROOT_URL', 'https://brucol.be/reg/contact/');
    define('DIR', '/var/www/brucol.be/reg/contact/form/');
    define('MAIN_DIR', '/var/www/brucol.be/reg/contact/');
    define('PAYMENT_URL', 'https://brucol.be/reg/contact/payment/');
    define('SURVEY_URL', 'https://brucol.be/reg/contact/form/surveys/');
