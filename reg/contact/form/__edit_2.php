...
<?php _header(); ?>
  ...
  <script>document.title="Edit-2 <?php echo $code ?>"</script>
    <h6>
        EDITTING
    </h6>
    ...
    <form class="uk-form-horizontal uk-margin-large" method="post" enctype="multipart/form-data">
            ...
            <div uk-grid>
                <div class="uk-width-expand">
                        ...
                        <fieldset class="uk-fieldset">
                          ...
                          gc('form_inputs', array('data' => $data, 'imadmin' => 1, 'noprice' =>'yes'));
                          ...
                          <div class="uk-margin">
                            ...
                            <a href="javascript:;" id="bank1" class="uk-button uk-button-default" style="margin-left: 14px; width: 80px; padding: 0px; margin-right: 10px;">Bank RO</a>
                ...
                <div class="uk-width-1-3" style="z-index: 980;">
                    <div>
                        <br>
                        <div class="uk-margin" style="display: none !important;">
                        ...
                        <table class="uk-table">
                          <tr>
                            ...
                            <td><?php 
                              ...
                              if ($data['status'] == 'pending') echo '<span style="background: #999; color: #fff; padding: 3px 10px;">PENDING</span>';
                              else if ($data['status'] == 'paid') echo '<span style="background: #07bd79; color: #fff; padding: 3px 10px;">PAID</span>';
                              else echo '<span style="background: #ddd; color: #333; padding: 3px 10px;">'.strtoupper(@$data['status']).'</span>';
                              ?></td>
                          </tr> 
                          <tr>
        ...
        <input type="hidden" name="edit2" value="yes">
