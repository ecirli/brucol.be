#!/bin/bash
# filepath: /var/www/brucol.be/reg/apply/scripts/watch_database.sh

# Optionally set an end date (format: YYYY-MM-DD) to auto-stop the script.
# Leave blank to run indefinitely.
END_DATE=""

WATCH_DIR="/var/www/brucol.be/reg/apply/form/_database"
TARGET="/var/www/brucol.be/reg/apply/forum/topics/Abstracts & Presentations"
