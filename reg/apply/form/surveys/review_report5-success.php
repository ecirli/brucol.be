<?php 
      ...
      $firstcode = vget('firstcode');
       ...
       $code = _decrypt($_GET['code']);
					...
					$data1['review_portal']['papers_reviewed5'][$code] = 'yes';
      ...
      $data = unserialize($data);
			$uid = uniqid();
      $data['arws'] = 'yes';
      $data['reported_files'][] = $file_name;
      $data['reported_files'][] = $file_name1;
      $data['review_portal']['mypaperreviewed5'] = 'yes';
      ...
      $data = unserialize($data);
			...
			$subject = "Your Review Report 2 Peer";
       $htmlContent = '
            <html>
						<body>
                <h2> '.gc('conf_name_shortest').' Paper Review Report 2 Peer</h2>
                ...
                <br>                
							  ...
							  $htmlContent .= " <h4> <a href='".URL."upload-after-review-5.php?code=".$code."'> Review Report and Upload Tool</a></h4><br><br>";
...
<br>
The review report 2 peer has been submitted to <?php echo gc('conf_name_shortest')?> successfully.<br>
<br>
