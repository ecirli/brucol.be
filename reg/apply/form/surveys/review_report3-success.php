<?php 
      ...
      $firstcode = vget('firstcode');
       ...
       $code = _decrypt($_GET['code']);
					...
					$data1['review_portal']['papers_reviewed3'][$code] = 'yes';
      ...
      $data = unserialize($data);
			$uid = uniqid();
      $data['arws'] = 'yes';
      $data['review_portal']['mypaperreviewed3'] = 'yes';
       ...
       $htmlContent = '
            <html>
                ...
                <br>                
							  ...
							  $htmlContent .= " <h4> <a href='".URL."upload-after-review-3.php?code=".$code."'> Review Report and Upload Tool</a></h4><br><br>";
...
<br>
The review report 3 has been submitted to <?php echo gc('conf_name_shortest')?> successfully.<br>
<br>
