  ...
  p{
    ...
    <div id="page">
        ...
        <p style="font-size: 20px; margin: 20px 0px;">
            We are glad to inform you that your contribution titled; <b>“<?php echo strtotitle($data['paper_title']) ?>”</b> has been received, found relevant and <b>accepted</b> to be <?php echo $data['fee'] == 0 ? 'orally' : '' ?> presented at <strong><?php echo gc('ltr_conf_name') ?></strong> which will take place in <strong><?php echo gc('ltr_conf_venue_short') ?></strong> on <strong><?php echo gc('ltr_conf_date')?></strong>. 
						<br>
					<br>
...
<p style="font-size: 20px; margin: 20px 0px;">
	<?php echo $data['fee'] == 0 ? ' Now, you are welcome to join <strong> '.gc('conf_name_short').'</strong>, the international platform where more than <strong> '.gc('conf_exp_nr_part').'</strong> authors from <strong>'.gc('conf_exp_nr_cntr').'</strong>countries come together!' : ' Now, you are welcome to present your paper at the online platform of the <strong> '.gc('conf_name_short').'</strong>, the international conference where more than <strong> '.gc('conf_exp_nr_part').'</strong> authors from <strong>'.gc('conf_exp_nr_cntr').'</strong>countries come together!'; ?>
	 </p>
        <br>
