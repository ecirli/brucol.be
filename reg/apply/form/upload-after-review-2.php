           ...
           <br>
            ...
            <h2>
               ...
               <b> REVIEW REPORT</b>
                ...
                <br>
                <br>
                 <a href="review-report-pdf-2.php?code=<?php echo $code ?>" target="_blank" class="uk-button uk-button-primary">Download PDF version</a>
                
            </div>
              
                <div class="uk-width-1-2 uk-width-small-1-1 uk-width-medium-1-1" style="padding-left: 150px;">
                  <?php if ($data['surveys']['review_report2--file']) : ?>
                  <h2> Download your revised paper </h2>
                  <a href="<?php echo $data['surveys']['review_report2--file']; ?>" target="_blank" class="uk-button uk-button-primary">Click here to download</a>
                  <?php endif; ?>
