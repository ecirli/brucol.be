...
<img src="<?php echo gc('euser_logo')?>" style="width: 27%; margin-bottom: 00px; margin-top: 00px; float: right;">
	...
	<div class="de1">
		...
		<b> <?php echo $data['fee'] == 4 ? 'Listener Certificate': 'Presentation Certificate'; ?></b>
		<small> to the author</small>
		<h2><?php echo strtotitle(@$coas[$coa] ? $coas[$coa] : $data['name_surname']) ?></h2>
		<div class="title">
				<small><?php echo $data['fee'] == 4 ? 'for the participation and publishing the paper titled:': 'for presenting the scientific contribution titled:'; ?></small>
