...
//                         print_r($serc);
                                ...
                                $secp = ($spc[$hash1] <= 1 && $data['fee'] == 3 && $spc2[$hash2] <= 1) ? 1 : 0;
                                $secpa = ($data['fee'] == 3 && $spc2[$hash2]  <= 1 && $data['how_many_co'] <= 0) ? 1 : 0;
                        
                        
                                $secpb = ($data['fee'] == 3 && $spc2[$hash2] <= 1 && $data['how_many_co'] > 0) ? 1 : 0;
                                ...
                                echo '><a href="__edit.php?code='.$code.'" target="_blank">'.$found.' '.mb_substr(strtotitle($data['paper_title']), 0, 40, 'UTF-8').'</a></td>';
