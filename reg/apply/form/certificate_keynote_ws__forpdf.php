...
<img src="<?php echo gc('euser_logo')?>" style="width: 27%; margin-bottom: 00px; margin-top: 00px; float: right;">
	...
	<div class="de1">
		...
		<div class="title">
				<small>for presenting the scientific contribution titled:</small>
				<b><?php echo unserialize($data['surveys']['keynote'])['keytitle'] ?></b>
      <br>
      in the plenary session at the conference.
      <br>
      <br>
