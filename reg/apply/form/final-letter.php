...
<div class="company-address">
      ...
      <strong>Tel, WhatsApp:</strong> <?php echo gc('ltr_conf_tel')?><br>
        ...
        <p style="margin: 20px 0px;font-size: 18px;">
         ...
         <?php echo $data['fee'] == 2 ? ' We are glad to inform you that your contribution titled <b>'.strtotitle($data['paper_title']).' </b> has been reviewed, found eligible and <b>accepted</b> to be presented virtually at the conference which will take place in <b> '.gc('ltr_conf_venue_short').'</b> on '.gc('ltr_conf_date').'.': ''; ?>

         <?php echo $data['fee'] == 3 ? ' We are glad to inform you that your contribution titled <b>'.strtotitle($data['paper_title']).' </b> has been reviewed, found eligible and <b>accepted</b> to be presented virtually at the conference which will take place in <b> '.gc('ltr_conf_venue_short').'</b> on '.gc('ltr_conf_date').'.': ''; ?>
