...
<img src="<?php echo gc('euser_logo')?>" style="width: 27%; margin-bottom: 00px; margin-top: 00px; float: right;">
	...
	<div class="de1">
        ...
        echo strtotitle($data['name_surname'])
        //echo @$coas[$coa] ? strtotitle($coas[$coa]) : strtotitle($data['name_surname'])
      ?></h2>
		<div class="title">
				<small><b>for your valuable efforts in organizing the conference.</b></small>
			<br>
      <br>
