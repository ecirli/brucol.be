...
// error_reporting(E_ALL);
  ...
  date_default_timezone_set('Europe/Vienna');
    ...
    // CONFIG
    define('URL', 'https://brucol.be/reg/apply/form/');
    define('ROOT_URL', 'https://brucol.be/reg/apply/');
    define('DIR', '/var/www/brucol.be/reg/apply/form/');
    define('MAIN_DIR', '/var/www/brucol.be/reg/apply/');
    define('PAYMENT_URL', 'https://brucol.be/reg/apply/payment/');
    define('SURVEY_URL', 'https://brucol.be/reg/apply/form/surveys/');
