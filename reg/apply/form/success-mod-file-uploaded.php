...
<style>
    ...
    <div id="page" style="margin-top: 50px;">
        <div class="company-address">
            <?php echo date('d F Y') ?>
            <br>
            Ref. Nr: <?php echo $enc == 1 ? _encrypt($code) : $code ?>
            <p></p>
        </div>
        <div class="clear"></div>
        ...
        <p style="margin: 20px 0px;">
			...
			- If you want to make any modifications and intend to uploaded it again, use the same the upload link sent earlier. <br>
				In such a case we will always consider the latest version of your paper for publishing.<br>
			- Please note that, any document uploaded after <i> <?php echo gc('proofread_deadline')?> </i> will not be considered.
			<br>
			<br>
