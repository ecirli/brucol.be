    ...
    $data = unserialize($data);
        ...
        $htmlsubject = gc('conf_name_shortest');
				...
				$htmlcontent = '
						...
						<body>
						<div class="clear"></div>
									<h1 style="font-size: 25px; text-align: center;">File Uploaded Successfully!</h1>
									<div class="clear"></div>
									<p style="font-size: 18px; margin-top: 30px;">
										Dear presenter '.ucwords($data['name_surname']).',
									</p>
									<p style="margin: 20px 0px;">
					this is to confirm that you have sucessfully uploaded a presentation file regarding your title "'.strtotitle($data['surveys']['keynote']['keytitle']).'".</b>
					 <br>
					<br>
			   <b><span style= "color: red;">What is Next?</b><br>
				...
				- Please note that, any document uploaded exceeding 2 days before the conference date, will not be considered.<br>
				<br>
				<br>
						Thank you for the collaboration.<br>
											
					We believe that '.getconf('conf_name_short').' will be a better academic platform with your contribution.<br>
					<br>
					Best Regards<br>
					'.getconf('conf_name_short').' 
					<br>
        ...
        $eusercontent = '
           <html>
            <body>
                <h2> '.gc('conf_name_shortest').' A presentation Uploaded</h2><br>
...
<style>
    ...
    <div id="page" style="margin-top: 50px;">
        ...
        <p style="font-size: 18px; margin-top: 30px;">
            Dear presenter <b><?php echo ucwords($data['name_surname']) ?></b>,
        </p>
        <p style="margin: 20px 0px;">
				this is to confirm that you have sucessfully uploaded a document regarding your presentation regarding your title "<?php echo strtotitle($data['surveys']['keynote']['keytitle']) ?>".<br>
				<br>
	      Thank you.
				<br><br>
			<b><span style= "color: red;">What is Next?</b><br>
			...
			Best Regards<br>
			Mihaela Ioana<br>
			on behalf of the <?php echo gc('conf_name_short')?><br>
			Organizing Committee<br>
			<br>
