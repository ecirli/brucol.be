...
<img src="<?php echo gc('euser_logo')?>" style="width: 27%; margin-bottom: 00px; margin-top: 00px; float: right;">
	...
	<div class="de1">
		...
		<small> to </small>
		<h2><?php echo @$coas[$coa] ? strtotitle($coas[$coa]) : strtotitle($data['name_surname'])  ?></h2>
		<div class="title">
				<small><b>for session moderation and evaluation of presentations at the conference.</b></small>
			<br>
      <br>
