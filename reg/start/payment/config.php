<?php 
	...
	define('ROOT', $_SERVER['DOCUMENT_ROOT'].'/start/payment/');
	define('URL', 'https://brucol.be/reg/start/payment/');
	define('FORM_URL', 'https://brucol.be/reg/start/form/');
	define('FORM_DIR', $_SERVER['DOCUMENT_ROOT'].'/start/form/');
