...
// if(isset($_POST['age']) && ($_POST['age'] == "20+" || $_POST['age'] == "Select")) {
//     $error++;
// }
...
if ($error > 0) {
    ...
    die();
          ...
          // $hashc = md5(mb_substr(strtoupper(str_replace(' ', '', $result['name_surname2'].$result['paper_title2'])), 0, 55, 'UTF-8'));
          ...
          $result['time'] = time();
            ...
            echo '<script>$("#loading").html("Success... Wait for confirmation....").show(); setTimeout(function() {  window.location="success.php?code='.$f.'" }, 50);</script>';
