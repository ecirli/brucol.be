...
<div>
      ...
      <br>
		...
		<div class="title">
			...
			<h2><?php  echo gc('name_holder_category_org') ?></h2>
			</div>
...
/*
    ...
    $name = "http://88.99.140.80:83/api/render?url=".URL."name_holder__forpdf.php?code=".$code.$coa.'&pdf.landscape=false&pdf.width=355&pdf.height=238';
