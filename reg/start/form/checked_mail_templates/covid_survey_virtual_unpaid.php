<?php 
  ...
  $hcontent = '
                ...
                <p><span style="font-size: 14pt; color: blue;"><strong>	<a href="'.URL.'survey.php?code='.$code.'&type=covid_vrt_unp" target="_blank">Participation Replanning Survey</a></strong></span></p>
							  <br>
								<br>
								<b>P.S.</b>.
                <br>
