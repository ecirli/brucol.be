...
<br>
     ...
     <h2> Distant Presentation Upload Tool</h2>
                  
     <div>
     <p>Dear corresponding author <b><?php echo $data['name_surname'] ?></b>,
                <br>
       Please use the tool below to upload a presentation file, if any, regarding your title <b><?php echo $data['paper_title'] ?></b>. <br>
			 <br>
				<br>
					<br>
        				  </div>
 ...
 <div class="uk-margin" id="form_item_<?php echo $iii ?>">
								 ...
								 <?php 
										 ...
										 echo 'name="chng" id="radio" value="1" checked="checked">&nbsp; I do not want to send a presentation file. Just publish my contribution and send me a certificate.</label><br>';
										 echo '<label><input class="uk-radio chng radio_t_" type="radio"  ';
										 echo 'name="chng" id="radio" value="2">&nbsp; I want to send a presentation document for publishing (upload and submit)</label><br>';                       
                   ?>
        			  
                  </div>
                  <div class="uk-margin">
                    <div  class="_uf" style="display: none">
                     <div class="uk-form-label">Upload a presentation file (if any)</div>
        ...
        <input type="hidden" name="__type" value="distant">
...
<div style="float: right; width: 70%; margin-top: 10px; margin-bottom: 70px; clear: both;">
