...
$htmlContent2 = '
    <html>
    <body>
        <h2>'.gc('school_name').' Application</h2>
        <p>Dear <b>'.__ucwords($data['name_surname']).'</b>,</p>
        <p>We have sent an email regarding your application to <b>'.gc('school_name').'</b>. If you have already received it, please disregard this message.</p>
        <p>If you have not received the email, it may have been mistakenly directed to your spam folder. We kindly ask you to check your spam folder, and if you find the email there, please mark it as "Not Spam" to ensure future communications arrive in your inbox.</p>
        <p>Should you encounter any issues or fail to receive the email, please do not hesitate to contact us by replying to this message.</p>
        <p>We appreciate your cooperation.</p>
        <p>Warm regards,</p>
        <p>Admission Committee<br>'.gc('school_name').'</p>
    </body>
    </html>';
...
//secilenlere toplu kabul icin

if ($_POST['_ctype'] == "approve") {
			echo '<script>window.location="__approve.php?codes='.(implode(',', $list)).'"</script>';
