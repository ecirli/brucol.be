...
<div id="loading">Processing... Please wait...</div>
        ...
        <div class="uk-container">
            <div uk-grid>
                <div class="uk-width-expand">
                  <br>
                  <img src="<?php echo gc('form_logo')?>" style="width: 20%; margin-bottom: 20px; float: center" alt="">
  ...
  <fieldset class="uk-fieldset">
                 ...
                 ?>
                            ...
                            <div class="uk-margin">
                                <div class="uk-form-label"><em></em></div>
                ...
                <!--<div class="uk-width-1-3" style="z-index: 980; position: relative;">-->
                <!--    <div data-uk-sticky >-->
                <!--        <div class="uk-margin" style="margin-top: 130px;">-->
...
//                     console.log(a);
         ...
         $('input[type=file]').on('change', function() {
            var file1 = $('input[type=file]').prop('files')[0];
            if (file1 != 'undefined' && file1 != undefined) $('.__file').html('Selected: '+ file.name);
         });
