...
// error_reporting(E_ALL);
  ...
  date_default_timezone_set('Europe/Vienna');
    ...
    // CONFIG
    define('URL', 'https://brucol.be/reg/start/form/');
    define('ROOT_URL', 'https://brucol.be/reg/start/');
    define('DIR', '/var/www/brucol.be/reg/start/form/');
    define('MAIN_DIR', '/var/www/brucol.be/reg/start/');
    define('PAYMENT_URL', 'https://brucol.be/reg/start/payment/');
    define('SURVEY_URL', 'https://brucol.be/reg/start/form/surveys/');	
	define('DIRMailer', '/var/www/brucol.be/reg/');
