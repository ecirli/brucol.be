<?php
    ...
    if (!file_exists(DIR.'_database_bin/'.$code.'.txt')) alert('Data not found.');

    if (@$go) {
                    $data = getcontents(DIR.'_database_bin/'.$code.".txt");
        ...
        unlink(DIR.'_database_bin/'.$code.'.txt');
      
      
      
        echo '<script> window.location = "'.URL.'__list.php"; </script>';
        die();
    }
...
<body>
    ...
    <div id="container">
        ...
        <h3>
            Are you sure to restore this?
            
        </h3>

        <a href="__restore.php?code=<?php echo $code ?>&go=1">YES</a>
        <a href="__list_bin.php" style="color: #bbb">NO</a>
