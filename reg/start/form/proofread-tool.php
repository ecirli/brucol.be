...
<br>
     ...
     <h2> Proofreading Tool</h2>
                  
     <div>
     <p>Dear corresponding author <b><?php echo $data['name_surname'] ?></b>,
                <br>
       we are glad to inform you that the publisher has provided the print-ready draft version regarding your title <b><?php echo $data['paper_title'] ?></b>. <br>
			 <br>
			 At this point, we kindly request you to proofread your paper (modify where necessary) and send us your version using this tool .<br>
								<br>
								In order to do so:<br>
								1.<b><a href="<?php echo URL ?>_files_modified/<?php echo $code ?>.docx">Click here to download your paper for proofreading (<?php echo $code ?>.docx)</a></b><br>
        	        (<i><a href="<?php echo URL?>survey.php?code=<?php echo $code?>&type=send_correct_file">Here request the right version, if the above file is not yours </a></i>)<br>   
			          ...
			          4. Save it on your PC without changing the name of the file.<br>
								5. If you have not made any changes just click SUBMIT without making any selection.<br>
                6. If you have made any changes:<br>
 ...
 <div class="uk-margin" id="form_item_<?php echo $iii ?>">
        ...
        <input type="hidden" name="__type" value="modification">
