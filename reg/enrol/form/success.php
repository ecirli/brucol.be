...
<html>
    ...
    <body>
        <div class="main-container">
             ...
             <p>
                Dear <b>'.__ucwords($data['name_surname']).' '.__ucwords($data['surname']).'</b>,
             </p>
             <p>
...
<html>
    ...
    <body>
        <div class="main-container">
             <h2>Re: Your submission at '. getconf('conf_name_short') . '<br></h2>
             <p><b>'.__ucwords($data['name_surname']).' '.__ucwords($data['surname']).'</b>,
             </p>
             <p>
                We have successfully received your pre-enrolment submission. Our team will review it and respond within 3 business days.
             </p>
...
<body>
    <div class="container">
        ...
        <div class="content">
             ...
             <p>Dear <b><?php echo __ucwords($data['name']) ?> <?php echo __ucwords($data['surname']) ?></b>,</p>
