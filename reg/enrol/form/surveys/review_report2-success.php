<?php 
      ...
      $firstcode = vget('firstcode');
       ...
       $code = _decrypt($_GET['code']);
					...
					$data1['review_portal']['papers_reviewed2'][$code] = 'yes';
      ...
      $data['review_portal']['mypaperreviewed2'] = 'yes';
       ...
       $htmlContent = '
            <html>
                ...
                <br>                
							  ...
							  $htmlContent .= " <h4> <a href='".URL."upload-after-review-2.php?code=".$code."'> Review Report and Upload Tool</a></h4><br><br>";
...
<br>
The review report 2 has been submitted to <?php echo gc('conf_name_shortest')?> successfully.<br>
<br>
