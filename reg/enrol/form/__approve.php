...
<main class="email-content">
    ...
    <p>We are pleased to know your interest for admission into '.gc('school_name').'. At present, we have a spot available for you in '.$selectedOptionText.'*.</p>
...
<section style="background-color: #f2f2f2; padding: 10px; margin-bottom: 20px;"> 
   ...
   <section style="background-color: #f2f2f2; padding: 10px; margin-bottom: 20px;"> 
    <p>You are now ready to register for the selected program. For any queries, feel free to schedule a meeting with us, or proceed to complete your enrolment.
       <a href="'.URL.'survey.php?code='.$code.'&type=prtsrv" class="btn" target="_blank">Enrol or Schedule a Meeting</a>.
</section>
    ...
    <section class="email-content"> 
        ...
        <p>Our team is committed to reviewing your survey input to customize the optimal solution just for you. We aim to reach back to you swiftly, usually within the span of a day.</p>
        </section>
            </main>
            </body>
            </html>';
