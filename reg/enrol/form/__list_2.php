...
//           $pamount = $data['paid_amount'] + $data['discount_amount']
          ...
          $ptc[$hash2][$_code] = '<a href="__edit_2.php?code='.$_code.'" target="_blank" style="font-size: 8px;">'.$_code.'</a> ';
...
?>
  ...
  <body>
    ...
    margin-bottom: -9px;"></textarea>
          ...
          <option value="progress_status1">Progress 1</option>
          <option value="progress_status2">Progress 2</option>
          ...
          <option value="progress_status5">Progress5 Timetable v2</option>
...
//                         print_r($serc);
                                ...
                                echo '<td><a href="__edit_2.php?code='.$code.'" target="_blank">'.$nr.'</a></td>';
                                echo '<td';
                                ...
                                echo '><a href="__edit_2.php?code='.$code.'" target="_blank">'.$code.'</a></td>';
                                echo '<td ';
                               
                                echo '><a href="__edit_2.php?code='.$code.'" target="_blank">'.$found.' '.mb_substr(strtotitle($data['paper_title']), 0, 40, 'UTF-8').'</a></td>';
                                echo '<td><a href="__edit_2.php?code='.$code.'" target="_blank">'.($data['academic_title']).'</a></td>';
                                echo '<td><a href="__edit_2.php?code='.$code.'" target="_blank">'.strtotitle($data['name_surname']).'</a></td>';
...
//                                  echo '<a href="__edit_2.php?code='.$code.'" target="_blank">Edit</a>&nbsp;∙&nbsp;';
