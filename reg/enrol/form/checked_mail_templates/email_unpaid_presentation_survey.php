...
<?php 
  ...
  $_subject = 'Your Participation and Presentation Preference'; 

  $hcontent = '
           <html>
            <body>
            <h2> '.gc('conf_name_shortest').', Participation and Presentation Preference Feedback Tool</h2>
            <p>Dear corresponding author <b>'.ucwords($data['name_surname']).'</b>,
            <br>
            <br>
            We would like to remind you that your contribution has already been accepted for the conference, '.gc('conf_name_shortest').' which will be held virtually with live online presentations.
            <br>
            ...
            <br>
            <br>
            <b>At this point it is important for us to know your participation and presentation plans so that we organize the conference in an efficient way.</b>
            <br>
             <br>
            Regarding your <b>participation and presentation preference</b>, please fill in the following survey and SUBMIT.
            <br>
            <p><span style="font-size: 13pt; color: blue;"><strong>	<a href="'.URL.'survey.php?code='.$code.'&type=unpaid_prsnt" target="_blank">Provide Here Your Participation Status and Presentation Preference</a></strong></span></p>
            </p>
            <b><span style= "color: red;">What is Next?</b><br>
            - We will include you in one of the online sessions if you prefer to make a realtime oral presentation.<br>
