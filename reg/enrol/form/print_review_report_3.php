        ...
        Web: <a href="<?php echo gc('ltr_conf_web')?>" target="_blank"><?php echo gc('ltr_conf_web')?></a><br>
              ...
              <div class="uk-width-1-1 uk-width-small-1-1 uk-width-medium-1-1">
                ...
                After updating your paper considering the report, kindly send it using the <b>"Paper Upload Tool"</b> at the bottom of this page.
                 <br>
                 <br>
               <h2 style="font-size: 22px;"> REVIEW REPORT 3</h2>
                               
                <?php global $survey_type; $survey_type = 'review_report3'; gc('survey_inputs_output', array('data'=>$data)); ?>
...
<div id="stmp">
  <span style="    font-size: 9px;
    ...
    <img src="https://api.qrserver.com/v1/create-qr-code/?size=130x130&data=<?php echo URL ?>review-report-pdf-3.php?code=<?php echo $code ?>" style="float: right;">
        <p></p>
        <a href="<?php echo URL ?>review-report-pdf-3.php?code=<?php echo $code ?>" style="float: right; text-align: right; width: 100%; clear: both; font-size: 11px; color: blue; margin-top: 5px; color: blue;"><?php echo URL ?>review-report-pdf-3.php?code=<?php echo $code ?></a>
