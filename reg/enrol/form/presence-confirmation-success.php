...
<style>
    ...
    <div id="page" style="margin-top: 50px;">
        ...
        <div class="clear"></div>
        <h1 style="font-size: 35px; text-align: center;">Survey Submitted Successfully</h1>
        ...
        <p style="margin: 20px 0px;">
				this is to confirm that you have sucessfully submitted the survey results regarding your title "<b><?php echo $data['paper_title'] ?></b>"
				<br>
				<br>
			<b><span style= "color: red;">What is Next?</b><br>
			- We will use the data where necessary in making the conference detailed program according to your presence status. <br>
			- Please note that, any requests afterwards may not be considered as we have to complete the detailed program and announce as soon as possible..
			<br>
			<br>
