<?php
    ...
    if (@$go) {
       ...
       $htmlContent = '
        ...
        Header('Location: '.URL.'__list.php');
      }
...
<body>
    ...
    <div id="container">
        ...
        <h3>
            <?php 
            if (@$noemail == 'yes') echo 'Delete without sending email';
          else echo 'Delete with sending email';
          ?>
            
        </h3>

        <a href="__delete.php?<?php if (@$noemail) echo 'noemail='.$noemail.'&' ?>code=<?php echo $code ?>&go=1">YES</a>
