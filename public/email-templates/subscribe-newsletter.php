...
if( ! empty( $_POST['email'] ) ) {
	...
	if( $enable_mailchimp == 'no' ) { // Simple / SMTP Email
		...
		<tr>
		<td colspan="2" align="center" valign="top"><img style=" margin-top: 15px; " src="/images/logo-black.png" ></td>
		</tr>
		<tr>
		...
		if( $enable_smtp == 'no' ) { // Simple Email
			...
			if( mail( $receiver_email, $subject, $message, $headers ) ) {
				...
				if( ! empty( $redirect_page_url ) ) {
			   	...
			   	//Success Message
			  	echo '{ "alert": "alert-success", "message": "Your message has been sent successfully. <br> Subscribed to our email list!" }';
			} else {
				//Fail Message
