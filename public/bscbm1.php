    ...
    <div class="container">
        <div class="row justify-content-center"
            ...
            <div class="col-lg-8 md-mb-50px">
                ...
                <br>
                The programme requires English language proficiency at a minimum of <b>IELTS band 6.0</b>, with no component score below 5.5.<br>
                If you have completed your secondary education at an English-taught school, you may not need to provide a separate language certificate, provided the school can furnish a document to verify this.<br>
                If no English level document is provided, a student may be required to study our intensive English module before starting Year 1.<br>
                <br>
