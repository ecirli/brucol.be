                    ...
                    <div class="col-auto menu-order position-static">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav"> 
                            <ul class="navbar-nav alt-font"> 
                                <li class="nav-item"><a href="https://brucol.be" class="nav-link">Home</a></li>
                                ...
                                <li class="nav-item dropdown dropdown-with-icon">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                        <li>
                                            <a href="courses-details.html"><i class="bi bi-laptop"></i>
                                        ...
                                        <li>
                                            <a href="courses-details.html"><i class="bi bi-briefcase"></i>
                                                <div class="submenu-icon-content">
                                                    <span>Business</span>
                                        ...
                                        <li>
                                            <a href="courses-details.html"><i class="bi bi-vector-pen"></i>
                                                <div class="submenu-icon-content">
                                                    <span>Design</span>
                                        ...
                                        <li>
                                            <a href="courses-details.html"><i class="bi bi-megaphone"></i>
                                                <div class="submenu-icon-content">
                                                    <span>Marketing</span>
        ...
        <footer class="bg-gradient-aztec-green position-relative">
            ...
            <div class="container overlap-section">
                <div class="row g-0 justify-content-center align-items-center text-center bg-base-color border-radius-6px ps-5 pe-5 pt-3 pb-3 mb-8 sm-p-25px background-position-left-bottom background-no-repeat contain-background position-relative" style="background-image: url('images/bg-06.png')">
                    ...
                    <!-- start footer column -->
                    <div class="col-auto">
                        <a href="contact.html" class="btn btn-extra-large btn-dark-gray btn-rounded btn-box-shadow btn-switch-text d-inline-block me-20px align-middle xs-m-0">
                            <span>
                ...
                <div class="row mb-5 sm-mb-7 xs-mb-30px">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 d-flex flex-column last-paragraph-no-margin md-mb-40px xs-mb-30px">
                        <a href="https://brucol.be" class="footer-logo mb-15px d-inline-block">
                            <img src="images/footer-logo.png" data-at2x="images/footer-logo@2x.png" alt="">
                        </a>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 ps-4 last-paragraph-no-margin md-mb-40px xs-mb-30px"> 
                        ...
                        <ul>
                            <li><a href="courses.html">Business finance</a></li>
                            <li><a href="courses.html">Advanced design</a></li>
                            <li><a href="courses.html">Web development</a></li>
                            <li><a href="courses.html">Data visualization</a></li>
                        </ul> 
                    </div>
                    <!-- end footer column -->
                    <!-- start footer column -->
