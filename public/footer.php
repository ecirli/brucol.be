        ...
        <footer class="bg-gradient-aztec-green position-relative">
            <div class="position-absolute left-minus-100px top-25px">
                <img src="images/bg-05.png" alt="" class="w-80">
            </div>
            ...
            <div class="container overlap-section">
                <div class="row g-0 justify-content-center align-items-center text-center bg-base-color border-radius-6px ps-5 pe-5 pt-3 pb-3 mb-8 sm-p-25px background-position-left-bottom background-no-repeat contain-background position-relative" style="background-image: url('images/bg-06.png')">
                    <!-- start footer column -->
                    <div class="col-lg-auto lg-mb-20px">
                        <h6 class="alt-font fw-600 text-dark-gray m-0 ls-minus-1px d-inline-block me-30px lg-me-0">
                    ...
                    <!-- start footer column -->
                    <div class="col-auto">
                        <a href="inquiries" class="btn btn-extra-large btn-dark-gray btn-rounded btn-box-shadow btn-switch-text d-inline-block me-20px align-middle xs-m-0">
                            <span>
                                <span class="btn-double-text" data-text="Reach out">Learn More</span>
...
<!-- start footer column -->
                    <div class="col-lg-3 col-md-4 col-sm-6 d-flex flex-column last-paragraph-no-margin md-mb-40px xs-mb-30px">
                        ...
                        <div class="elements-social social-text-style-01 mt-9 xs-mt-15px">
                            <ul class="small-icon light fw-500">
                                <li>
                                    <address class="mb-0">
                                     Excelsiorlaan 5, 2<sup>nd</sup> Floor, 1930 Zaventem, Belgium
                                    </address>
                                </li>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 last-paragraph-no-margin xs-mb-30px">
                        ...
                        <a href="mailto:help@brucol.be" class="text-white text-decoration-line-bottom">info@brucol.be</a>
                    </div>
                    <!-- end footer column -->
                    <!-- start footer column -->
                    <div class="col-lg-3 col-md-12 col-sm-6 text-md-center text-lg-start">
                        ...
                        <div class="d-inline-block w-100 newsletter-style-02 position-relative mb-15px">
                           <form action="email-templates/subscribe-newsletter.php" method="post" class="position-relative w-100">
                                ...
                                <button type="submit" aria-label="submit" class="btn pe-20px text-white fs-13 fw-500 lg-ps-15px lg-pe-15px submit">
                                    Submit <i class="feather icon-feather-arrow-right submit"></i>
                                </button>
                        ...
                        <div class="d-inline-block">
                            ...
                            <a href="conditions" class="text-white text-decoration-underline">Protecting your privacy</a>
                        </div>
                        </div>
                    </div>
                    <!-- end footer column -->
                ...
                <div class="row align-items-center footer-bottom border-top border-color-transparent-white-light pt-30px g-0">
                    ...
                    <div class="col-xl-7 ps-0 text-center text-xl-start lg-mb-10px">
                        <ul class="footer-navbar fs-16 lh-normal">
                            <li class="nav-item active"><a href="https://brucol.be" class="nav-link ps-0">Home</a></li>
                            <li class="nav-item"><a href="about" class="nav-link">About</a></li>
                            <li class="nav-item"><a href="courses" class="nav-link">Programmes</a></li>
                            <li class="nav-item"><a href="facilities" class="nav-link">Campus</a></li>
                    ...
                    <div class="col-xl-5 last-paragraph-no-margin text-center text-xl-end">
                        <p class="fs-16">&copy; <?php echo date('Y'); ?> Brussels College</p>
                    </div>
                    <!-- end copyright -->
                </div>
            </div>
