            ...
            <div class="container">
                ...
                <h2 class="alt-font text-dark-gray fw-600 ls-minus-3px mx-auto">
                    ...
                    <p class="fs-16 fw-300 text-dark-gray mb-30px">
                        Brussels College offers a streamlined pathway to a globally recognized UK degree through our <b>Integrated Degree Programmes</b>. Our unique model allows you to complete your entire academic journey on campus in Brussels while earning a UK qualification through an approved UK partner institution.
                    </p>
                    <p>
                        <b>Our Academic Model: What is "Integrated Degree Programme"?</b>
                        <br>
                        Our integrated approach is built on providing UK-regulated and articulated qualifications, from a one-year Foundation programme to Higher National Diplomas (HNDs) up to Level 8, all delivered on campus. Regulated by UK Ofqual, our Foundation Qualifications offer essential for standalone regulated diploma programmes and also academic preparation for progression to undergraduate degrees. An optional English module is also available to ensure language proficiency and a smooth academic transition.
                    </p>
                    <p>
                        <b>Undergraduate and Postgraduate Degrees</b>
                        <br>
                        We offer these integrated undergraduate and postgraduate programmes on our Brussels campus. The foundation, year one, and year two are delivered entirely by our local faculty. The final year of the programme is a blended model, combining a minimum of 45 local credits, a local internship, and distance learning from a partner institution. This integrated approach culminates in a top-up bachelor's degree awarded by a UK university, without having to leave Belgium.

                        <br>
                        Ultimately, this innovative framework provides a transparent and efficient route for you to obtain a UK degree while studying in the heart of Europe.
                    </p>
                    ...
                    <div class="row row-cols-auto row-cols-sm-2" data-anime='{ "el": "childs", "translateX": [30, 0], "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay":100, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        ...
                        <div class="col align-self-start">
                            <div class="feature-box text-start ps-30px pe-30px xl-pe-5px sm-pe-0">
                                ...
                                <div class="feature-box-content last-paragraph-no-margin pt-30 md-pt-21 sm-pt-40px">
                                    ...
                                    <p>This one-year on-campus programme provides the essential academic foundation for undergraduate studies in Business, Education, or Computer Science. The awarded qualification is a UK Ofqual-regulated diploma that allows you to progress to an integrated degree programme. An optional English module is available to ensure a smooth transition.
                        ...
                        <div class="col align-self-end mt-25 xs-mt-30px">
                            <div class="feature-box text-start ps-30px pe-30px xl-pe-5px sm-pe-0">
                                ...
                                <div class="feature-box-content last-paragraph-no-margin pt-30 md-pt-21 sm-pt-40px">
                                    <span class="text-dark-gray fs-20 d-inline-block fw-600 mb-5px">Integrated Undergraduate Degree Programmes</span>
                                <p>We offer integrated undergraduate programmes in Business, Computer Science, and Education. Students benefit from a comprehensive curriculum while gaining valuable experience through the courses and internships. Upon completion, you are awarded a UK degree.</p>
                                    <span class="w-60px h-3px bg-yellow d-inline-block"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col align-self-start mt-minus-12 xs-mt-30px">
                            <div class="feature-box text-start ps-30px pe-30px xl-pe-5px sm-pe-0">
                                ...
                                <div class="feature-box-content last-paragraph-no-margin pt-30 md-pt-21 sm-pt-40px">
                                    <span class="text-dark-gray fs-20 d-inline-block fw-600 mb-5px">Integrated Postgraduate Degree Programmes</span>
                                    <p>Our integrated postgraduate programmes in business, computer science, and education are offered through a collaboration with UK partners, incorporating local internships. Upon completion, you are awarded a UK degree.</p>
                                    <span class="w-60px h-3px bg-yellow d-inline-block"></span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row mt-4">
                    <div class="col-12 d-flex justify-content-center">
                        ...
                        <!-- <ul class="pagination pagination-style-01 fs-13 mb-0 fw-500">
                            <li class="page-item"><a class="page-link" href="courses03"><i class="feather icon-feather-arrow-left fs-18 d-xs-none"></i></a></li>
                            <li class="page-item active"><a class="page-link" href="courses">p1</a></li>
                            <li class="page-item"><a class="page-link" href="courses02">p2</a></li>
                            <li class="page-item"><a class="page-link" href="courses03">p3</a></li>
                            <li class="page-item"><a class="page-link" href="courses02"><i class="feather icon-feather-arrow-right fs-18 d-xs-none"></i></a></li>
                        </ul> -->
                        <!-- end pagination -->
                    </div> 
                </div>
