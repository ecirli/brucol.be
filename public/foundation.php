            ...
            <div class="container">
                <div class="row align-items-center extra-small-screen">
                    <div class="col-xl-6 col-lg-7 col-md-8 col-sm-9 position-relative page-title-extra-small" data-anime='{ "el": "childs", "translateY": [-15, 0], "perspective": [1200,1200], "scale": [1.1, 1], "rotateX": [50, 0], "opacity": [0,1], "duration": 800, "delay": 200, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        <h1 class="mb-20px alt-font text-yellow">Prep Schools</h1>
                        <h2 class="fw-500 m-0 ls-minus-2px text-white alt-font">
                            Master English and Dutch in our specialized preparatory schools designed for academic success.
                        </h2>
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-center">                  
                    <div class="col-lg-5 col-md-10 position-relative md-mb-40px sm-mb-25px" data-anime='{ "opacity": [0,1], "duration": 600, "delay":100, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        ...
                        <div class="icon-with-text-style-08 mb-20px">
                            <div class="feature-box feature-box-left-icon-middle">
                                ...
                                <div class="feature-box-content last-paragraph-no-margin">
                                    <span class="d-inline-block alt-font fs-19 fw-500 ls-minus-05px text-dark-gray">Expert Language Training</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <p class="fs-16 fw-300 text-dark-gray mb-30px">
                            Our preparatory schools are designed to provide immersive language training in English and Dutch. Whether you're aiming for higher education or professional advancement, our expert-led courses offer the linguistic skills and confidence you need to succeed in a globalised world.
                        </p>
                        <a href="inquiries" class="btn btn-large btn-dark-gray btn-box-shadow btn-rounded btn-switch-text">
                            <span>
                                <span class="btn-double-text" data-text="Inquire Now">Inquire Now</span>
                        ...
                        <div class="row row-cols-auto row-cols-sm-2" data-anime='{ "el": "childs", "translateX": [30, 0], "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay":100, "staggervalue": 300, "easing": "easeOutQuad" }'>
                            ...
                            <div class="col align-self-start">
                                <div class="feature-box text-start ps-30px pe-30px xl-pe-5px sm-pe-0">
                                    ...
                                    <div class="feature-box-content last-paragraph-no-margin pt-30 md-pt-21 sm-pt-40px">
                                        <span class="text-dark-gray fs-20 d-inline-block fw-600 mb-5px">English Prep School</span>
                                        <p>Intensive training designed to elevate your English proficiency for academic and professional success, preparing you for Bachelor's or Master's studies.</p>
                            ...
                            <div class="col align-self-end mt-25 xs-mt-30px">
                                <div class="feature-box text-start ps-30px pe-30px xl-pe-5px sm-pe-0">
                                    ...
                                    <div class="feature-box-content last-paragraph-no-margin pt-30 md-pt-21 sm-pt-40px">
                                        <span class="text-dark-gray fs-20 d-inline-block fw-600 mb-5px">Voorbereidende School Nederlands</span>
                                        <p>A comprehensive course tailored for non-native speakers to build a strong foundation in Dutch for academic and professional environments.</p>
                                        <span class="w-60px h-3px bg-yellow d-inline-block"></span>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="container overlap-gap-section">
                <div class="row align-items-center mb-4">
                    <div class="col-12 text-center">
                        <h2 class="alt-font text-dark-gray fw-600 ls-minus-3px mb-0">Our Prep Schools</h2>
                    </div>
                </div>

                <div class="row">
                    <div class="col-12 filter-content p-md-0">
                        <ul class="portfolio-wrapper grid-loading grid grid-2col xxl-grid-2col xl-grid-2col lg-grid-2col md-grid-2col sm-grid-1col xs-grid-1col gutter-extra-large">
                            ...
                            <li class="grid-item transition-inner-all">
                                <div class="services-box-style-06 border-radius-6px hover-box overflow-hidden box-shadow-large">
                                   <div class="image">
                                        <a href="https://brucol.be/english-prep" target="_blank"><img src="https://via.placeholder.com/800x550" alt="" /></a>
                                    </div> 
                                    <div class="bg-white position-relative">
                                        <div class="bg-dark-gray w-80px h-80px md-w-75px md-h-75px rounded-circle d-flex justify-content-center align-items-center fw-500 text-white fs-20 position-absolute right-30px top-minus-40px"><i class="fa-solid fa-earth-americas"></i></div>
                                        <div class="ps-35px pe-35px pt-30px pb-30px border-bottom border-color-transparent-dark-very-light xl-ps-25px xl-pe-25px">
                                            <span class="d-block mb-10px"><a href="https://brucol.be/english-prep" target="_blank" class="text-dark-gray text-uppercase fs-15 fw-600 services-text">English Prep School</a></span>
                                            <div class="d-flex align-items-center mb-5px">
                                                <a href="https://brucol.be/english-prep" target="_blank" class="text-dark-gray fw-600 fs-19 md-fs-18 lh-28 w-90">Intensive English Preparatory Programme</a>
                                            </div>
                                        </div> 
                                        <div class="d-flex justify-content-center align-items-center ps-35px pe-35px xl-ps-25px xl-pe-25px pt-15px pb-20px">
                                            <div class="me-auto">
                                               <a href="https://brucol.be/english-prep" target="_blank" class="text-dark-gray fs-16 fw-500 d-inline-block">
                            ...
                            <li class="grid-item transition-inner-all">
                                <div class="services-box-style-06 border-radius-6px hover-box overflow-hidden box-shadow-large">
                                    <div class="image">
                                        <a href="https://taalme.be" target="_blank"><img src="https://via.placeholder.com/800x550" alt="" /></a>
                                    </div> 
                                    <div class="bg-white position-relative">
                                        <div class="bg-dark-gray w-80px h-80px md-w-75px md-h-75px rounded-circle d-flex justify-content-center align-items-center fw-500 text-white fs-20 position-absolute right-30px top-minus-40px"><i class="fa-solid fa-earth-europe"></i></div>
                                        <div class="ps-35px pe-35px pt-30px pb-30px border-bottom border-color-transparent-dark-very-light xl-ps-25px xl-pe-25px">
                                            <span class="d-block mb-10px">
                                                <a href="https://taalme.be" target="_blank" class="text-dark-gray text-uppercase fs-15 fw-600 services-text">
                                                    Voorbereidende School (TaalMe)
                                                </a>
                                            </span>
                                            <div class="d-flex align-items-center mb-5px">
                                                <a href="https://taalme.be" target="_blank" class="text-dark-gray fw-600 fs-19 md-fs-18 lh-28 w-90">
                                                    Uitgebreid Nederlands Voorbereidend Programma – bekijk het volledige aanbod op de speciale TaalMe-website
                                                </a>
                                            </div>
                                        </div>
                                        <div class="d-flex justify-content-center align-items-center ps-35px pe-35px xl-ps-25px xl-pe-25px pt-15px pb-20px">
                                            <div class="me-auto">
                                               <a href="https://taalme.be" target="_blank" class="text-dark-gray fs-16 fw-500 d-inline-block">
                                                <i class="feather icon-feather-clipboard text-dark-gray d-inline-block me-5px"></i>
                                                <span>Meer Info</span>
                                               </a>
                                            </div>
